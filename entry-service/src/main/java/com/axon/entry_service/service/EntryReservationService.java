...
public class EntryReservationService {
     ...
     * @param meta                campaign activity metadata used to determine participation eligibility and limit
     * @param requestedAt         the timestamp of the reservation request (used to check participatability)
    ...
    /**
     * Removes a user's reservation from the participant set for the specified campaign activity in Redis.
     *
     * @param campaignActivityId the campaign activity identifier whose participant set will be modified
     * @param userId             the user identifier to remove from the participant set
     */
     ...
     *
     * @return the Redis key in the form {@code "campaign:<campaignActivityId>:users"}
     */
